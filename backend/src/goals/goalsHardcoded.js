...
let LTG1 = {
  userId: "testUser1",
  title: "Run a marathon in 2 years",
  description: "irrelevant words",
  shortTermGoals: [
    {
      title: "Run for 30 minutes every weekday evening.",
      mon: [5, 15],
      wed: [30, 20]
    },
    {
      title: "Run for 2 hours every weekend day.",
      sat: [5, 15],
      sun: [30, 20]
    },
...
let LTG2 = {
  userId: "testUser2",
  title: "Play guitar like Jimmy Hendrix within a few years.",
  description: "irrelevant words",
  shortTermGoals: [
    {
      title: "Work at the pitch and putt to save up for an electric guitar.",
      mon: [15, 25],
      wed: [30, 20]
    },
    {
      title:
        "Practice playing on mom's acoustic guitar until you get the electric guitar.",
      sat: [5, 15],
      sun: [30, 20]
    },
    {
      title: "Do finger training with the finger pump machine thingy.",
      mon: [5, 15],
      wed: [30, 20]
    }
  ]
...
let LTG3 = {
  ...
  shortTermGoals: [
    ...
    {
      title:
        "Every Sunday, visit a makerspace and see what people are up to, coding-wise, for inspiration.",
      mon: [5, 15],
      wed: [30, 20]
    }
  ]
...
let LTG4 = {
  ...
  shortTermGoals: [
    { title: "Cook meals at home", mon: [100], tue: [30], wed: [4] },
    ...
    {
      title: "Buy whole grain and high protein products",
      mon: [100],
      tue: [30],
      wed: [4]
    }
...
let LTG5 = {
  userId: "testUser5",
  title: "Stop procrastinating and be more productive",
  description: "I want to get more work done in less time.",
  shortTermGoals: [
    {
      title: "Have regularly scheduled work periods",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    ...
    {
      title: "Plan my week ahead of time with an agenda",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    {
      title: "Do a small task in the morning",
      mon: [100],
      tue: [30],
      wed: [4]
    },
...
let LTG6 = {
  ...
  shortTermGoals: [
    { title: "Budget my money for each week", mon: [100], tue: [30], wed: [4] },
...
let LTG7 = {
  ...
  shortTermGoals: [
    { title: "Smile more often", mon: [100], tue: [30], wed: [4] },
    {
      title: "Write down what I'm grateful for",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    {
      title: "Straighten my back and adjust my posture",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    ...
    {
      title: "Read a self-help book for 15 minutes",
      mon: [100],
      tue: [30],
      wed: [4]
    },
...
let LTG8 = {
  userId: "testUser8",
  title: "Feel less lonely by being more social",
  description: "I want to feel more connected to the people around me",
  shortTermGoals: [
    {
      title: "Talk to a new person in my environment",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    {
      title: "Call a friend or family member for 30 minutes",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    { title: "Give a stranger a compliment", mon: [100], tue: [30], wed: [4] },
    {
      title: "Message 3 people and start a conversation",
      mon: [100],
      tue: [30],
      wed: [4]
    }
...
let LTG9 = {
  userId: "testUser9",
  title: "Reduce my anxiety and feel more calm",
  description: "I want to be more relaxed in order to think more clearly.",
  shortTermGoals: [
    { title: "Meditate", mon: [100], tue: [30], wed: [4] },
...
let LTG10 = {
  ...
  shortTermGoals: [
    ...
    { title: "Drink a warm beverage", mon: [100], tue: [30], wed: [4] },
    {
      title: "Sleep at the same time everyday",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    {
      title: "Wake up at the same time everyday",
      mon: [100],
      tue: [30],
      wed: [4]
    },
...
let LTG11 = {
  ...
  shortTermGoals: [
    { title: "Practice for 1 hour", mon: [100], tue: [30], wed: [4] },
...
let LTG12 = {
  ...
  shortTermGoals: [
    { title: "Review my resume", mon: [100], tue: [30], wed: [4] },
    ...
    {
      title: "Reach out to someone and network",
      mon: [100],
      tue: [30],
      wed: [4]
    }
...
let LTG13 = {
  ...
  shortTermGoals: [
    { title: "Attend a local event", mon: [100], tue: [30], wed: [4] },
    { title: "Look into clubs to join", mon: [100], tue: [30], wed: [4] },
    {
      title: "Start a conversation with a new person",
      mon: [100],
      tue: [30],
      wed: [4]
    }
...
let LTG14 = {
  ...
  shortTermGoals: [
    {
      title: "Go to the library or bookstore",
      mon: [100],
      tue: [30],
      wed: [4]
    },
...
let LTG15 = {
  ...
  shortTermGoals: [
    { title: "Donate to charity", mon: [100], tue: [30], wed: [4] },
    {
      title: "Look into volunteering opportunities",
      mon: [100],
      tue: [30],
      wed: [4]
    },
    ...
    {
      title: "Assemble care packages with nessecities for those in need",
      mon: [100],
      tue: [30],
      wed: [4]
    },
...
let LTG16 = {
  userId: "testUser16",
  title: "Be stronger by building muscle",
  description: "Being toned and muscular will improve my self-confidence",
  shortTermGoals: [
    { title: "Sleep more", mon: [100], tue: [30], wed: [4] },
...
let LTG17 = {
  ...
  shortTermGoals: [
    ...
    {
      title: "Notice 3 things about the present moment",
      mon: [100],
      tue: [30],
      wed: [4]
    },
...
let LTG18 = {
  userId: "testUser18",
  title: "Take good care of myself",
  description: "Self-care will improve my mental health.",
  shortTermGoals: [
    { title: "Check in with myself", mon: [100], tue: [30], wed: [4] },
    { title: "Take deep breaths", mon: [100], tue: [30], wed: [4] },
    { title: "Journal", mon: [100], tue: [30], wed: [4] },
    { title: "Take a 30 minute walk", mon: [100], tue: [30], wed: [4] },
    ...
    {
      title: "Take a break and do a relaxing activity",
      mon: [100],
      tue: [30],
      wed: [4]
    },
